...
export const ADMIN_AUDIT_ACTIONS = [
  ...
  "membership.block",
  "membership.invite",
  "membership.onboarding.approved",
  "membership.onboarding.denied",
  "membership.community_code.used",
  ...
  "platform.customer.onboarding.started",
  "platform.customer.ready",
  "platform.customer.health.viewed",
  "platform.customer.support.created",
  "platform.customer.onboarding.updated",
  "platform.customer.alert.created",
  "platform.customer.alert.resolved",
  "platform.analytics.viewed",
  "platform.report.generated",
  "platform.analytics.exported",
  "platform.plan.changed",
  "platform.features.updated",
  "platform.limits.changed",
  ...
  "community.announcement.acknowledged",
